...
def _build_fill_prompt(company_data: dict[str, Any], detected_tables: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "- NON duplicare la stessa azienda su più righe quando la tabella rappresenta più imprese, consorziate, mandanti, ausiliarie, operatori economici o soggetti diversi.\n"
        "- Se il JSON contiene una sola azienda e la tabella ha più righe per più soggetti/operatori, compila al massimo la riga chiaramente riferita all'operatore principale; lascia vuote le altre righe.\n"
        "- Non compilare righe generiche tipo consorzio/impresa/mandante/ausiliaria solo perché nel JSON esiste ragione_sociale, partita_iva o sede dell'azienda.\n"
