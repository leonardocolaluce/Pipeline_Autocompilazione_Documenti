...
QC_SYSTEM_PROMPT = (
    ...
    "\n"
    "OBIETTIVO UNICO\n"
    "Devi decidere se la SCRITTURA INSERITA (testo compilato) è verticalmente troppo in basso rispetto alla sua riga/box.\n"
    "Ignora completamente: correttezza dei dati, contenuto del modulo, allineamento orizzontale, spaziatura orizzontale.\n"
    "Guarda SOLO la posizione verticale del testo inserito rispetto alle linee/underline dei campi.\n"
    "\n"
    "DEFINIZIONE DI 'SCRITTO MALE' (good=false)\n"
    "Metti good=false se noti ALMENO UNO di questi segnali:\n"
    "1) Il testo inserito è sotto la linea/underline del suo campo (baseline visibilmente sotto la linea), ANCHE SE resta nel campo.\n"
    "2) Il testo inserito cade nella fascia della riga successiva (anche solo parzialmente).\n"
    "3) Il testo inserito sta nella metà inferiore dello spazio tra due righe (più vicino alla riga sotto che alla sua linea).\n"
    "IMPORTANTE: basta un singolo caso per good=false.\n"
    "\n"
    "COME CONTROLLARE (obbligatorio)\n"
    "Per orientarti, LEGGI e controlla questi anchor (se presenti):\n"
    "- Anchor DATA: riga con 'nato a' / 'il' o comunque la riga della data (es. '12/05/1973').\n"
    "- Anchor NOME: riga del nome (es. 'MARIO ROSSI').\n"
    "- Anchor CODICE FISCALE: riga 'Cod. Fiscale' e valore alfanumerico.\n"
    "- Anchor 'Il sottoscritto': frase sopra e nome compilato sotto.\n"
    "Se in UNO QUALSIASI anchor il testo compilato è troppo basso -> good=false.\n"
    "\n"
    "REGOLA CONSERVATIVA\n"
    "Se hai anche solo un dubbio, rispondi good=false.\n"
    "\n"
    "Output: restituisci ESCLUSIVAMENTE un JSON valido, senza testo extra, con questo schema:\n"
    "{\n"
    "  \"good\": true|false,\n"
    "  \"confidence\": 0.0-1.0,\n"
    "  \"reason\": \"anchor=<data|nome|cf|sottoscritto> signal=<baseline_below_line|touches_next_row|lower_half|ok>\"\n"
    "}\n"
)
