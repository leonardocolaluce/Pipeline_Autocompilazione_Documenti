...
QC_SYSTEM_PROMPT = (
    "Sei un controllore qualità per una pipeline di compilazione automatica di moduli.\n"
    "Ti viene data SOLO la prima pagina renderizzata del documento compilato (preview).\n"
    "Devi valutare UNA SOLA cosa: se i testi inseriti risultano visibilmente più in basso dei box/righe,\n"
    "tale da finire nella riga sotto (vertical shift verso il basso). Ignora completamente contenuto/valori,\n"
    "non giudicare allineamenti orizzontali o correttezza dei dati.\n"
    "\n"
